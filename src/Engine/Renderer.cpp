...
//
//template<int size>
//void Renderer<size>::FillBuffers(std::unique_ptr<Voxel>& voxel){
...
//
//template<int size>
//void Renderer<size>::AddVoxel(std::unique_ptr<Voxel>& voxel){
...
//
//template<int size>
//void Renderer<size>::ResetVoxels(){
...
//
//template<int size>
//void Renderer<size>::HandleKeyboard(){
//  auto state = SDL_GetKeyboardState(nullptr);
//  camera_->ProcessKeyboard(state, delta_time_);
//}
//
//template<int size>
//void Renderer<size>::ProcessMouse(double x_pos, double y_pos){
//  camera_->ProcessMouse(x_pos, y_pos);
//}
//
//template<int size>
//GUI& Renderer<size>::GetGui(){
//  return gui_;
//}
//
//template<typename ChunkType>
//void Renderer<ChunkType>::ProcessChunk(ChunkType& chunk){
//  SetRandomColours(chunk);
//  for (auto& voxel: chunk){
//    if (*voxel) AddVoxel(voxel);
//  }
//}
//
//template<typename ChunkType>
//void Renderer<ChunkType>::Render() {
//  HandleKeyboard();
//  ShowGUI();
...
//
//template<typename ChunkType>
//void Renderer<ChunkType>::ShowGUI(){gui_.ShowGUI();}
//
//template<typename ChunkType>
//void Renderer<ChunkType>::Export(const std::string& filename){}
//
//template<typename ChunkType>
//void Renderer<ChunkType>::SetRandomColours(ChunkType& chunk){
